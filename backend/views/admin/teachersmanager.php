					...
					[
						...
						'buttons'=>[
							...
							'delete'=>function ($url, $model) {
								return Html::a('<span class="glyphicon glyphicon-trash"></span>', ['admin/deleteteacher' , 'id'=>$model['IdMaestro']], ['title' => 'Eliminar','data-confirm' => '¿Desea eliminar el elemento '.$model['IdMaestro'].'?']);
							},
						],
					],
					'Nombre',
