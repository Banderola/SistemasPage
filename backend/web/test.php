        ...
        <ul class="side-menu-list">
            ...
            <li class="purple with-sub">
				...
				<ul>
					...
					<li><a class="lbl" href="/SistemasPage/backend/web/index.php?r=admin%2Fspecialitycategorymanager"><span class="lbl">Categoría</span></a></li>
				</ul>
            </li>
            <li class="green with-sub">
				...
				<ul>
					...
					<li><a class="lbl" href="/SistemasPage/backend/web/index.php?r=admin%2Fprojectcategorymanager"><span class="lbl">Categoría</span></a></li>
				</ul>              
            </li>
